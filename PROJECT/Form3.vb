Public Class Form3
    'sub procedure to check answer for question3
    Private Sub checkAnswer()
        If radA.Checked = True Then
            radA.BackColor = Color.Red
            radB.BackColor = Color.Green
            ...
            Form7.lblQuestion2.Text = "0/1"
        ElseIf radC.Checked = True Then

            radB.BackColor = Color.Green
            radA.BackColor = Color.Transparent
        ...
        ElseIf radB.Checked = True Then
            ...
            Form7.lblQuestion2.Text = "1/1"
        End If
    End Sub

    'sub procedure for validation when user do not check any of the checkbox
    Private Sub Check()
    ...
    'event handling for menustrip Menu
